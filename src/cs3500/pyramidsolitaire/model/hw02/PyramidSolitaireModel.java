...
/**
 * The model for playing a game of Pyramid Solitaire: this maintains
 * the state and enforces the rules of gameplay.
...
public interface PyramidSolitaireModel<K> {
   ...
   *                  the number of pyramid rows or number of available draw cards is non-positive,
   *                  or a full pyramid and draw pile cannot be dealt with the number of given
   *                  cards in deck
   *
   */
  ...
  /**
   * Execute a two-card move, using the specified card from the draw pile and
   * the specified card from the pyramid.
   * @param row    row of the desired card position, numbered from 0 from the top of the pyramid
   * @param card   card of the desired card position, numbered from 0 from left
   * @throws IllegalArgumentException if the move is invalid
   * @throws IllegalStateException if the game has not yet been started
